...
MANUAL_POINT1 = geom.Point(477, 432)
MANUAL_POINT2 = geom.Point(477, 432 + 5)
...
def eval(paths, m, session, max_path_length=MAX_PATH_LENGTH, segment_length=SEGMENT_LENGTH, save=False,
...
if __name__ == '__main__':
    ...
    for REGION in city_list:
        output_fname = "/data/cities/out/graph_infer/roadtracer/"
        ...
        print(result)
        save_path = output_fname + REGION + ".out.graph"
        path.graph.save(save_path)

...
def train_operation(train_paras):
    ...
    solver = MyFrame(BSNet, learning_rate, model_name)
...
if __name__ == "__main__":
    image_list_dir = "/tiny_dataset/boost_train/"
    train_id = 2
    logfile_dir = "log/"
    model_dir = 'weights/'
    model_name = 'dlinknet_dupsample_test' + str(train_id)
    sat_dir = '/tiny_dataset/D1/original/sat/'
    lab_dir = '/tiny_dataset/D1/original/lab/'

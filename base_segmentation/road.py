...
def test(strDataPath, strModelPath, strOutPath):
	...
	print("e.g., /home/htht_whdx/road/model/road_20200421-11:28.th")
...
if __name__=="__main__":
    ...
    if 'data' in dic:
    	...
    	strDataPath = '/home/htht_whdx/road/data/'

    if 'model' in dic:
    	strModelPath = dic['model']
    else:
    	strModelPath = '/home/htht_whdx/road/model/'

    if 'out' in dic:
    	strOutPath = dic['out']
    else:
    	strOutPath = '/home/htht_whdx/road/out/'
